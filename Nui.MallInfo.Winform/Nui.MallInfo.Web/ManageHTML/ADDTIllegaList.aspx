<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDTIllegaList.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDTIllegaList" %>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style=" line-height:45px">
              ...
              <tr>
                ...
                <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">手机：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_phone" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_tel" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                 ...
                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">邮箱：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                ...
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                 ...
                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">QQ：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_QQ" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                 ...
                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">微博：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_MicroBlogURL" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                 ...
                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">微信：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_WeChat" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">网址：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_HttpUrl" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_Address" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
