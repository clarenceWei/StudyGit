<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDCustomerCenter.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDCustomerCenter" %>
...
<body>
  ...
  <tr>
    ...
    <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">客户中心</div></td>
      </tr>
    </table></td>
        ...
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="nowtable">
              <tr>
                <td class="left_bt2">&nbsp;&nbsp;&nbsp;&nbsp;客户中心的添加、修改</td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style=" line-height:45px">
             ...
             <%--   <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">级别：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_level" runat="server" Width="400px">0</asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_vedio" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>--%>
              ...
              <tr>
                <td align="right" class="style1">描述：</td>
                <td class="style2">&nbsp;&nbsp;</td>
