<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserManage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.UserManage" %>
        ...
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_newcatename" runat="server" Width="240px"></asp:TextBox>
                                                    </td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td height="30">
                    <asp:TextBox ID="txt_pwd" runat="server" Width="240px"></asp:TextBox>
                                                    </td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td colspan="3">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" >
              <tr><td><table  width="100%" border="0" cellpadding="0" cellspacing="0" class="nowtable"><tr><td class="left_bt2">&nbsp;&nbsp;&nbsp;&nbsp;用户列表</td></tr></table></td></tr>
                <tr><td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="userName" 
                              HeaderText="用户名称" NavigateUrl="SysAdmin/ManageHTML/NewsCateManage.aspx" 
                              DataNavigateUrlFormatString="UserManage.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
              ...
              <td width="70%" height="30" align="left" style="padding-left:100px">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <asp:Button ID="btn_cancle" runat="server" Text="取   消" 
                      onclick="btn_cancle_Click" style="height: 21px" />
                </td>
