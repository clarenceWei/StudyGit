<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDCustomerCenterCate.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDCustomerCenterCate" %>
...
<body>
  ...
  <tr>
    ...
    <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">客户类型</div></td>
      </tr>
    </table></td>
          ...
          <tr>
            <td><table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="90%" valign="top"><span class="left_txt2">在这里，您可以根据您的网站要求，对客服分类进行有效管理！</span><br>
                          <span class="left_txt2">包括对客户分类的添加，修改，删除。</span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
              ...
              <tr>
                ...
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    <asp:Label ID="lb_catename" runat="server" Font-Size="9pt" ForeColor="Red"></asp:Label>
                      ...
                      <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">排序：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_level" runat="server" Width="240px">0</asp:TextBox>
                ...
                <tr><td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="CateName" 
                              HeaderText="分类名称" NavigateUrl="SysAdmin/ManageHTML/ADDCustomerCenterCate.aspx" 
                              DataNavigateUrlFormatString="ADDCustomerCenterCate.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
                          <asp:BoundField DataField="AddDate" DataFormatString="{0:yyyy-MM-dd}" 
                              HeaderText="添加时间">
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                           <asp:BoundField DataField="SortLevel" HeaderText="排序级别" />
