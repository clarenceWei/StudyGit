<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDCateLaws.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDCateLaws" %>
...
<body>
  ...
  <tr>
    ...
    <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">政策法规</div></td>
      </tr>
    </table></td>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_title" runat="server" Width="240px"></asp:TextBox>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="Title" 
                              ...
                              DataNavigateUrlFormatString="ADDCateLaws.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
