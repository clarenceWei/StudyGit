<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDMemberInfo.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDMemberInfo" %>
...
<body>
  ...
  <tr>
    ...
    <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">会员服务</div></td>
      </tr>
    </table></td>
        ...
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td><table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="90%" valign="top"><span class="left_txt2">
                    在这里，您可以根据您的网站的需求添加会员查询信息、经济商查询的添加 </span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="nowtable">
              <tr>
                <td class="left_bt2">&nbsp;&nbsp;&nbsp;会员服务详细信息添加、修改</td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style=" line-height:45px">
              ...
              <tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_CompanyName" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="txt_CompanyName" ErrorMessage="文本不为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                     </td>
              </tr>

                <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">公司网址：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_CompanyUrl" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_OperaHead" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:DropDownList ID="Drop_isbroker" runat="server" Width="260px">
