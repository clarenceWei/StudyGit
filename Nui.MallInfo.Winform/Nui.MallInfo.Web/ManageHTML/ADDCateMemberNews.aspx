<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDCateMemberNews.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDCateMemberNews" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="Title" 
                              ...
                              DataNavigateUrlFormatString="ADDCateMemberNews.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
