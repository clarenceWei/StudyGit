<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownLoadManage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.DownLoadManage" %>
            ...
            <td align="left" bgcolor="#CCCCCC">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="标题">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    NavigateUrl='<%# Eval("ID", "ADDDownLoad.aspx?id={0}") %>' ToolTip='<%#Eval("SoftName") %>' Text='<%# Eval("SoftName").ToString().Length>35?Eval("SoftName").ToString().Substring(0,32)+"...":Eval("SoftName") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="UpdateDate" HeaderText="插入时间" 
                        ...
                        <asp:BoundField DataField="Applicablesystem" HeaderText="适用系统" />
                        <asp:BoundField DataField="SoftUrl" HeaderText="软件地址" />
