<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDDownLoad.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDDownLoad" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#uploadify").uploadify({
                ...
                'script': 'updata.aspx?mid=2',
                'cancelImg': '../uploadify/cancel.png',
                'folder': 'data',
                'queueID': 'fileQueue',
                'auto': false,
                'multi': false,
                'fileExt': '*.doc;*.pdf;*.rar;*.zip;*.txt;*.ppt;*.7z;*.apk,*.ipa;',
                'fileDesc': '请选择doc rar pdf zip txt ppt 7z apk文件',
                'sizeLimit': 536870912000,
                'onError': function (e, queueID, fileObj, errorObj) {
                    window.art.dialog({
                        title: '警告',
                        content: "最大支持30M,请重新选择文件！",
                        close: function () {
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style=" line-height:45px">
              ...
              <tr>
                ...
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                 ...
                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">软件名称：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_SoftName" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="txt_SoftName" ErrorMessage="文本不为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                     </td>
              </tr>
              ...
              <tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_Versions" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_Applicablesystem" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
          ...
          <%--    <tr>
               ...
               <%--      <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">附件名称：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_AttachName" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>--%>
               ...
               <tr>
                <td align="right" class="style1">上传软件：</td>
                <td class="style2">&nbsp;</td>
                <td colspan="2" class="style2" style="padding-top:15px;">
                    ...
                    <asp:Label ID="Label1" runat="server" Text="Label" Visible="False"></asp:Label>
                      ...
                      <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">简介：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_DES" runat="server" Width="449px" Height="98px" 
