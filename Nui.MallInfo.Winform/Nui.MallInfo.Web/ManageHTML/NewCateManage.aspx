<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCateManage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.NewCateManage" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="CateName" 
                              ...
                              DataNavigateUrlFormatString="NewCateManage.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
