<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductMetalsManage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ProductMetalsManage" %>
                        ...
                        <asp:TemplateField HeaderText="标题">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    NavigateUrl='<%# Eval("ID", "ADDProductMetals.aspx?id={0}") %>' ToolTip='<%#Eval("Title") %>' Text='<%# Eval("Title").ToString().Length>35?Eval("Title").ToString().Substring(0,32)+"...":Eval("Title") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
