<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbountManage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.AbountManage" %>
            ...
            <td align="left" bgcolor="#CCCCCC">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="标题">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    NavigateUrl='<%# Eval("ID", "ADDAbount.aspx?id={0}") %>' ToolTip='<%#Eval("Title") %>' Text='<%# Eval("Title").ToString().Length>35?Eval("Title").ToString().Substring(0,32)+"...":Eval("Title") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="Vedio_Url" HeaderText="视屏链接" />
