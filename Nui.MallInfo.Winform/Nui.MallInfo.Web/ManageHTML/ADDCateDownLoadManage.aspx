<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDCateDownLoadManage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDCateDownLoadManage" %>
...
<body>
  ...
  <tr>
    ...
    <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">下载类型</div></td>
      </tr>
    </table></td>
    ...
    <td valign="top" bgcolor="#F7F8F9" colspan="2"><table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：下载类型管理</td>
          </tr>
          <tr>
                ...
                <tr><td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="SoftName" 
                              HeaderText="分类名称" NavigateUrl="SysAdmin/ManageHTML/NewsCateManage.aspx" 
                              DataNavigateUrlFormatString="ADDCateDownLoadManage.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
                          <asp:BoundField DataField="UpdateDate" DataFormatString="{0:yyyy-MM-dd}" 
                              HeaderText="添加时间">
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
