<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDCateAbout.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDCateAbout" %>
        ...
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="90%" valign="top"><span class="left_txt2">在这里，您可以根据您的网站要求，对关于我们分类进行有效管理！</span><br>
                          <span class="left_txt2">包括对分类的添加，修改，删除。</span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="nowtable">
              <tr>
                <td class="left_bt2">&nbsp;&nbsp;&nbsp;&nbsp;关于我们分类具体信息</td>
              </tr>
            </table></td>
          </tr>
          <tr>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="Title" 
                              ...
                              DataNavigateUrlFormatString="ADDCateAbout.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
                          ...
                          <ItemStyle HorizontalAlign="Center" />
                           ...
                           <asp:BoundField DataField="Level" HeaderText="排序" />
