<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductMetalsCateMage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ProductMetalsCateMage" %>
    ...
    <td valign="top" bgcolor="#F7F8F9" colspan="2"><table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：政策法规分类管理</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">总分类：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:DropDownList ID="Drop_cateID" runat="server" Width="260px">
                    </asp:DropDownList>
                                                    </td>
              ...
              <tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_title" runat="server" Width="260px"></asp:TextBox>
                ...
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    ...
                    <asp:Label ID="lb_delete" runat="server" Font-Size="9pt" ForeColor="Red"></asp:Label>
                                                    </td>
              </tr>
                <%--          <tr>
                ...
                <tr><td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="TypeName" HeaderText="总分类" />
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="Title" 
                              HeaderText="分类名称" NavigateUrl="Admin/ManageHTML/ADDCateLaws.aspx" 
                              DataNavigateUrlFormatString="ProductMetalsCateMage.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
