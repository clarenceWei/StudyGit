<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsManage.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.NewsManage" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="标题">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    NavigateUrl='<%# Eval("ID", "ADDNews.aspx?id={0}") %>' ToolTip='<%#Eval("Title") %>' Text='<%# Eval("Title").ToString().Length>15?Eval("Title").ToString().Substring(0,13)+"...":Eval("Title") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="附件名称">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" ToolTip='<%# Bind("AttachName") %>' Text='<%# Bind("AttachName").ToString().Length>15?Eval("AttachName").ToString().Substring(0,13)+"...":Eval("AttachName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="AttachUrl" HeaderText="附件地址" />
                        <asp:BoundField DataField="SourceName" HeaderText="来源名称" />
