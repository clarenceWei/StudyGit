<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDHiringInfo.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.ADDHiringInfo" %>
...
<body>
  ...
  <tr>
    ...
    <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">招聘信息</div></td>
      </tr>
    </table></td>
    ...
    <td valign="top" bgcolor="#F7F8F9" colspan="2"><table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：添加与修改</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="nowtable">
              <tr>
                <td class="left_bt2">&nbsp;&nbsp;&nbsp;招聘信息的添加、修改</td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style=" line-height:45px">
              ...
              <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">职位：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_position" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="txt_position" ErrorMessage="文本不为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                  </td>
              </tr>

                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">部门：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_Department" runat="server" Width="400px"></asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ControlToValidate="txt_Department" ErrorMessage="文本不为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                     </td>
              </tr>

                <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">招聘人数：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_Number" runat="server" Width="400px">0</asp:TextBox>
                  </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ControlToValidate="txt_Number" ErrorMessage="请输入数字！" ForeColor="Red" 
                        ValidationExpression="^[0-9]\d*$"></asp:RegularExpressionValidator>
                    </td>
              </tr>
		
              <tr>
                <td align="right" class="style1">职位描述：</td>
                <td class="style2">&nbsp;&nbsp;</td>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:DropDownList ID="Drop_isValid" runat="server" Width="200px">
