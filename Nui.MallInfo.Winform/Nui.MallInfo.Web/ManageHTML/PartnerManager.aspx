<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartnerManager.aspx.cs" Inherits="Nui.MallInfo.Web.ManageHTML.PartnerManager" %>
...
<body>
  ...
  <tr>
    ...
    <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">合作伙伴管理</div></td>
      </tr>
    </table></td>
    ...
    <td valign="top" bgcolor="#F7F8F9" colspan="2"><table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：新闻分类管理</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">公司名称：</td>
                ...
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                 ...
                 <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">链接地址：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
                    <asp:TextBox ID="txt_httpurl" runat="server" Width="240px"></asp:TextBox>
                                                    </td>
                <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    &nbsp;</td>
              </tr>
                      <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">公司logo：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td colspan="3">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" >
              <tr><td><table  width="100%" border="0" cellpadding="0" cellspacing="0" class="nowtable"><tr><td class="left_bt2">&nbsp;&nbsp;&nbsp;&nbsp;列表管理</td></tr></table></td></tr>
                <tr><td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                      ...
                      <Columns>
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="CompanyName" 
                              HeaderText="分类名称" NavigateUrl="SysAdmin/ManageHTML/NewsCateManage.aspx" 
                              DataNavigateUrlFormatString="PartnerManager.aspx?id={0}" >
                          <ItemStyle HorizontalAlign="Center" />
                          </asp:HyperLinkField>
                          <asp:BoundField DataField="ImgUrl" HeaderText="图片地址" />
                          <asp:BoundField DataField="httpurl" HeaderText="链接地址" />
