<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="Nui.MallInfo.Web.UserList" %>
    ...
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="935" height="29" valign="top" background="../images/content-bg.gif" colspan="2">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
                        <tr>
                            <td height="31">
                                <div class="titlebt">用户管理</div>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td valign="top" bgcolor="#F7F8F9" colspan="2">
                    <table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <td>
                                            <table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="90%" valign="top"><span class="left_txt2">在这里，您可以根据您的网站要求，对用户列表进行有效管理！</span><br>
                                                        <span class="left_txt2">包括对用户的添加，修改，删除。</span></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                        ...
                        ControlToValidate="txt_name" ErrorMessage="文本不为空！" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                ...
                                                <tr>
                                                    <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">用户名称：</td>
                                                    <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                                                    <td width="32%" height="30" bgcolor="#f2f2f2">
                                                        <asp:TextBox ID="txt_level" runat="server" Width="240px"></asp:TextBox>
                                                        <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ControlToValidate="txt_level" ErrorMessage="请输入数字！" ForeColor="Red" 
                                                    ...
                                                    <td height="17"  colspan="4" align="right">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                            <asp:Button ID="btn_add0" runat="server" Text="查   询" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td>
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="U_ACCOUNT" HeaderText="用户账号" />
                                                                <asp:BoundField DataField="U_NAME" HeaderText="用户名称" />
                                                                <asp:BoundField DataField="U_PHONE" HeaderText="手机号码" />
                                                                <asp:BoundField DataField="U_EMAIL" HeaderText="Email邮箱" />
                                                                <asp:BoundField DataField="U_ROLEID" HeaderText="角色编号" />
                                                                <asp:HyperLinkField DataNavigateUrlFields="U_ROLEID" DataTextField="U_ROLENAME"
                                                                    HeaderText="角色名称" NavigateUrl="SysAdmin/ManageHTML/NewsCateManage.aspx"
                                                                    DataNavigateUrlFormatString="MemberCateManage.aspx?U_ROLEID={0}">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:HyperLinkField>
                                                                ...
                                                                <asp:BoundField DataField="MemoText" HeaderText="备注" />
                                                                <asp:BoundField DataField="EditUser" HeaderText="编辑用户" />
                                                                <asp:BoundField DataField="EditDate" HeaderText="编辑日期" />
            ...
            <tr>
                ...
                <td height="17" valign="top" background="../images/buttom_bgs.gif" colspan="2">
