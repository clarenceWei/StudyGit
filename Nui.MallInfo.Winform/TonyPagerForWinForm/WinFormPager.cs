    ...
    public partial class WinFormPager : UserControl
    {
        ...
        public int PageSize
        {
            ...
            set
            {
                if (value <= 1)
                {
                    value = Convert.ToInt32(TotalSize.Text.Trim());
                }
        ...
        protected void SetLabelLocation()
        {
            try
            {
                ...
                this.label2.Left = (this.btnToPageIndex.Left + this.btnToPageIndex.Width) + 10;
                this.TotalSize.Left = this.label2.Left + this.label2.Width;
                this.label1.Left = this.TotalSize.Left + this.TotalSize.Width;
                this.button1.Left = this.label1.Left + this.label1.Width;
            }
            catch (Exception ex)
            {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                txtToPageIndex.Text = num2.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string str = @"^[1-9]\d*$";
                Match math = Regex.Match(TotalSize.Text.Trim(), str);


                if (!math.Success)
                {
                    MessageBox.Show("输入正确的格式！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                    return;
                }

                PageSize = Convert.ToInt32(TotalSize.Text.Trim());
                this.txtToPageIndex.Text = "1";
